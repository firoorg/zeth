...
it("is prime function: Run " + (init_runs-run) + " - create random prime value, assert contract returns true", async function() {
        ...
        do {
            ...
            } while(!(prime_bn.isProbablePrime())); //generate random values until we hit a probable prime (fast).
        ...
        console.log("prime_enc: " + prime_enc);
        console.log("bit_size: " + bit_size);
        console.log("randomness_enc: " + randomness_enc);
        console.log("num_randomness: " + num_randomness);
                   
      let result = await instance.mock_is_prime(prime_enc, bit_size, randomness_enc, num_randomness)
      .then(function(result) {
        console.log(actual_result.tx)
        console.log(actual_result.logs)
        console.log(actual_result.receipt)
      })
