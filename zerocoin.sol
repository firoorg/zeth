...
contract zerocoin is bigint_functions, parameters { //inherit all members from bigint
     ...
     */
      ...
      */
    address deployment; //address of contract creators. Ability to perform limited changes and for contract deployment.
    ...
    //RSA-2048 Factoring Challenge encoded as bytes and a bigint respectively.
    bytes modulus_bytes;
    bigint bigint_modulus = create_bigint(8, ); //RSA-2048
